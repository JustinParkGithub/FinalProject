...
public class GameFrame extends javax.swing.JFrame {
    ...
    private void userInputKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userInputKeyPressed
        ...
        if (evt.getKeyCode() == 10) {
            ...
            if (answer.equals(generateLabel.getLabel1Text()) == true) {
                //move label to top
                wordsTyped.add(generateLabel.getLabel1Text());
                generateLabel.label1Text(randomWords.getRandomWords());
                generateLabel.randomLocationLabel(0);
            }
            if (answer.equals(generateLabel.getLabel2Text()) == true) {
                //move label to top
                wordsTyped.add(generateLabel.getLabel2Text());
                generateLabel.label2Text(randomWords.getRandomWords());
                generateLabel.randomLocationLabel(1);
            }
            if (answer.equals(generateLabel.getLabel3Text()) == true) {
                //move label to top
                wordsTyped.add(generateLabel.getLabel3Text());
                generateLabel.label3Text(randomWords.getRandomWords());
                generateLabel.randomLocationLabel(2);
            }
            if (answer.equals(generateLabel.getLabel4Text()) == true) {
                //move label to top
                wordsTyped.add(generateLabel.getLabel4Text());
                generateLabel.label4Text(randomWords.getRandomWords());
                generateLabel.randomLocationLabel(3);
            }
            if (answer.equals(generateLabel.getLabel5Text()) == true) {
                //move label to top
                wordsTyped.add(generateLabel.getLabel5Text());
                generateLabel.label5Text(randomWords.getRandomWords());
                generateLabel.randomLocationLabel(4);
            }

            //Opens Game Over frame when all labels are empty - Written by Justin
            if (generateLabel.allEmptyLabels() == true) {
                gameThread.interrupt();
                gameOver.setTextArea(wordsTyped);
